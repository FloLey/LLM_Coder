...
def create_project(state):
    ...
    2. Create a single new virtual environment in a venv folder in the project folder
    3. Create a single "src" folder in the project folder
    4. Create a single "tests" folder in the project folder
    4. Return the result as a pydantic object
        """
    ...
    # Tools
    tools = [create_virtual_env_tool, create_directory_tool, Project]
    ...
    agent_executor = AgentExecutor(
        agent=agent,
        tools=[create_virtual_env_tool, create_directory_tool],
        verbose=True
    )
